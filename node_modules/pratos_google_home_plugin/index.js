...
globalFunctions.homebridge = function(text){
				...
				Accessories.list_accessories(globalVariableIn);
				globalVariableIn.event.on("accessories", show_list_accessories);
				function show_list_accessories (answer, data){
					if(answer == "list:obtained"){
						globalVariableIn.event.removeListener("accessories", show_list_accessories);
