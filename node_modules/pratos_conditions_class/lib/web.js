...
globalVariable[req.user_id].request.bodyPratos.code = "var schedule = require('node-schedule'); functions = require('pratos_conditions_class').functions; module.exports ={ init : function(globalVariable){"+ globalVariable[req.user_id].request.bodyPratos.code+"}};";
