...
module.exports = {
					...
					if (!working) {
						...
						if (y.test(global)) {
							...
							module.exports.set_global_colors(parseInt(RegExp.$1), parseInt(RegExp.$3), parseInt(RegExp.$5), 255, function() {
								module.exports.change_logo_color(parseInt(RegExp.$1), parseInt(RegExp.$3), parseInt(RegExp.$5), 255, function() {
	...
	change_logo_color: function(r, g, b, a, callback) {
		var arrayFiles = {
			'/static/img/website-icons/android-chrome-192x192.png': {
				width: 192,
				height: 192
			},
			'/static/img/website-icons/apple-touch-icon-114x114.png': {
				width: 114,
				height: 114
			},
			'/static/img/website-icons/apple-touch-icon-120x120.png': {
				width: 120,
				height: 120
			},
			'/static/img/website-icons/apple-touch-icon-144x144.png': {
				width: 144,
				height: 144
			},
			'/static/img/website-icons/apple-touch-icon-152x152.png': {
				width: 152,
				height: 152
			},
			'/static/img/website-icons/apple-touch-icon-180x180.png': {
				width: 180,
				height: 180
			},
			'/static/img/website-icons/apple-touch-icon-57x57.png': {
				width: 57,
				height: 57
			},
			'/static/img/website-icons/apple-touch-icon-60x60.png': {
				width: 60,
				height: 60
			},
			'/static/img/website-icons/apple-touch-icon-72x72.png': {
				width: 72,
				height: 72
			},
			'/static/img/website-icons/apple-touch-icon-76x76.png': {
				width: 75,
				height: 76
			},
			'/static/img/website-icons/favicon-16x16.png': {
				width: 16,
				height: 16
			},
			'/static/img/website-icons/favicon-32x32.png': {
				width: 32,
				height: 32
			},
			'/static/img/website-icons/favicon-96x96.png': {
				width: 96,
				height: 96
			},
			'/static/img/website-icons/favicon.png': {
				width: 32,
				height: 32
			},
			'/static/img/website-icons/largetile.png': {
				width: 310,
				height: 310
			},
			'/static/img/website-icons/mediumtile.png': {
				width: 150,
				height: 150
			},
			'/static/img/website-icons/smalltile.png': {
				width: 70,
				height: 70
			},
			'/static/img/website-icons/widetile.png': {
				width: 310,
				height: 150
			}
		};
