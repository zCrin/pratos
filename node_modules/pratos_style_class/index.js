...
module.exports = {
change_logo_color:function(r, g, b, a){
...
change_color(path+"/static/img/logo2.png", path+"/static/img/logo.png", Jimp.rgbaToInt(r, g, b, a),arrayFiles);
}

};
function change_color(pathTo,pathNew,color,saveList){
