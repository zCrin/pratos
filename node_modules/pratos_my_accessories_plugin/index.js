...
setTimeout(function(){http.get('http://192.168.0.6:51828/?accessoryId=sensor2&state=false',(resp)=>{}).on('error',function(err){
	console.log("Homebridge not started : L100 my_accessories");
	});},20000);
}
}
...
setTimeout(function(){http.get('http://192.168.0.6:51828/?accessoryId=son1&state=false',(resp)=>{}).on('error',function(err){
