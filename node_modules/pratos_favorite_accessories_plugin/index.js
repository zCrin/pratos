...
fs.writeFile( __dirname + '/favorite_accessory.list', JSON.stringify(file));
	...
	content:function(link){
		link["favorite_accessory_plugin1"]={"page":"admin/index|admin/manage_accessories","script":"<script src='/favorite_accessory.js'></script>"};
link["favorite_accessory_plugin2"]={"page":"admin/index","script":" <script src='/socket.io/socket.io.js'></script>"};
