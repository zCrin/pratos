...
function update_accessories(user_id,globalVariable, callback){
		if(globalVariable[user_id].request.body. oldName){
			var oldName = globalVariable[user_id].request.body.oldName;
			globalVariable.event.emit("accessories", "editing:starting");
				...
				if(globalVariable[user_id].request.body.name){
					updated_accessories.accessories[oldName].name = globalVariable[user_id].request.body.name;
				}
if(globalVariable[user_id].request.body.room){
					updated_accessories.accessories[oldName].room = globalVariable[user_id].request.body.room;
				}
				if(globalVariable[user_id].request.body.manufacturer){
					updated_accessories.accessories[oldName].manufacturer = globalVariable[user_id].request.body.manufacturer;
				}
				if(globalVariable[user_id].request.body.model){
					updated_accessories.accessories[oldName].model = globalVariable[user_id].request.body.model;
				}
				if(globalVariable[user_id].request.body.icon_on){
					updated_accessories.accessories[oldName].icon_on = globalVariable[user_id].request.body.icon_on;
				}
				if(globalVariable[user_id].request.body.icon_off){
					updated_accessories.accessories[oldName].icon_off = globalVariable[user_id].request.body.icon_off;
				}
